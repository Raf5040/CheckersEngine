...
public class Square extends Canvas {
	...
	public Square(Square square) {
		...
		if(square.getBackgroundColor() == BackgroundColor.DARK)
			this.setBackground(Color.DARK_GRAY);
		else
			this.setBackground(Color.LIGHT_GRAY);

		this.bgColor = square.getBackgroundColor();
		this.occupied = square.isOccupied();
		if(occupied) {
			this.occupant = new Piece(square.getOccupant());
		}
		else {
			this.occupant = null;
		}
